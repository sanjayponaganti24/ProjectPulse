...
export function TeamPage() {
  ...
  if (loading)
    return <LoadingState message="Loading workspace team directory..." />;
          ...
          return (
            ...
            >
              ...
              >
                <div>
                  <strong
                    style={{ fontSize: 16, color: "#0f172a", display: "block" }}
                  >
                    {userTasks.length}
                  </strong>
          ...
          {squads.map((squad) => (
            ...
            >
              ...
              >
                ...
                >
                  <Avatar
                    name={squad.lead?.name || "Project manager"}
                    avatar={squad.lead?.avatar}
                    size="xs"
                  />
                  <strong style={{ fontSize: 13, color: "#0f172a" }}>
                    {squad.lead?.name || "Project manager"}
                  </strong>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <span>
                    Active: <strong>{squad.activeProject}</strong>
                  </span>
                </div>
...
export function WorkloadPage() {
  ...
  if (loading)
    return <LoadingState message="Calculating workload balance..." />;

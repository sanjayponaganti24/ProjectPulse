...
export default function LandingPage() {
  ...
  return (
    <div
      style={{ minHeight: "100vh", background: "#f8fafc", color: "#1e293b" }}
    >
      {/* Top Navigation */}
      <header
        style={{
      ...
      >
        ...
        >
          ProjectPulse eliminates project friction. Centralize tasks, track
          milestone velocity, unblock issues, and align every contributor in one
          clean workspace.
        </p>
      ...
      >
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{ color: "#64748b", fontSize: 14, marginTop: 8 }}>
            Everything you need from initial product specification to
      ...
      >
        <p>
          © 2026 ProjectPulse Agile Suite. Designed with clean SaaS aesthetics.
        </p>
      </footer>
    </div>
  );

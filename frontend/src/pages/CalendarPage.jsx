...
export default function CalendarPage() {
  ...
  if (loading)
    return <LoadingState message="Generating schedule calendar..." />;
        ...
        <Card style={{ padding: 16 }}>
          ...
          >
            {calendarDays.map((day, idx) => {
              ...
              const dayDeliverables = deliverables.filter(
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 6,
                    background:
                      dayDeliverables.length > 0 ? "#ffffff" : "#ffffff",
                    display: "flex",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {deliverables.map((item) => (
                ...
                >
                  ...
                  >
                    <Badge
                      tone={item.type === "project" ? "active" : item.priority}
                    >
                      {item.type === "project"
                        ? "Project Deadline"
                        : item.priority}
